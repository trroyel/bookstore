...
<head>
    ...
    <title>Books List - Bookstore</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2>
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-books" viewBox="0 0 16 16" style="margin-right: 8px;">
                    <path d="M5.1 13.147c.87-.169 1.804-.35 2.746-.538.906-.18 1.81-.364 2.697-.554L10.53 4.22c-.884.187-1.774.376-2.658.566-.89.19-1.78.38-2.664.572L5.1 13.147zm4.114-9.07a2.848 2.848 0 0 1-.362.145.5.5 0 0 1-.238-.033.492.492 0 0 1-.253-.314l.02-.003c.08-.017.159-.034.239-.054.08-.018.159-.038.239-.058a2.848 2.848 0 0 1 .362-.145.5.5 0 0 1 .238.033.492.492 0 0 1 .253.314l-.02.003c-.08.017-.159.034-.239.054a15.5 15.5 0 0 1-.239.058zM3.5 11.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zm0-4a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zm0-4a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zm7 8a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zm0-4a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0zm0-4a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0z" />
                </svg>
                All Books
            </h2>
            <?php if (hasPermission('book:create')): ?>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <form method="GET" action="/books/search" class="d-flex">
                    <input type="text" name="q" class="form-control me-2" placeholder="Search books by title, author, or ISBN..." value="<?= htmlspecialchars($_GET['q'] ?? '') ?>">
            ...
            <div class="col-md-6 text-end">
                <span class="text-muted">Total: <?= count($books ?? []) ?> books</span>
            </div>
        </div>
                        ...
                        <tr>
                            <td colspan="7" class="text-center py-4">
                                <div class="text-muted">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" class="bi bi-book" viewBox="0 0 16 16" style="opacity: 0.3;">
                                        <path d="M1 2.828c.885-.37 2.154-.829 3.388-.829 1.234 0 2.503.46 3.388.829V13.17c-.885.37-2.154.83-3.388.83-1.234 0-2.503-.46-3.388-.83V2.828zM8 13.17c.885.37 2.154.83 3.388.83 1.234 0 2.503-.46 3.388.83V2.828c-.885-.37-2.154-.829-3.388-.829-1.234 0-2.503.46-3.388.829v10.342z" />
                                    </svg>
                                    <p class="mt-2">No books found</p>
                                    <a href="/books/create" class="btn btn-primary btn-sm">Add First Book</a>
                                </div>
                            </td>
                        </tr>
                    <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        <?php endif; ?>
                                        <?php if (hasPermission('book:delete')): ?>
